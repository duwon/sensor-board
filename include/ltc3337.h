...
struct ltc3337_status {
    bool     bat_ok;        /**< I2C 기반 proxy OK (GPIO BATOUT_OK 있으면 상위에서 덮어쓰기 권장) */
    ...
    uint32_t used_mah;      /**< mah_used_fs와 동일(명확성 위해 별도) */
    ...
    /* 전압/온도/임피던스 */
    uint32_t vbat_in_on_uv;
    uint32_t vbat_in_off_uv;
    uint32_t vbat_out_on_uv;
    uint32_t vbat_out_off_uv;
